...
export type Settings = { paused: boolean; accessibilityEnabled: boolean; activityEnabled: boolean; retentionDays: number; calendarUrl: string; whisperModel: string; handsFree: boolean; excludedApps: string[]; benchmarkKeyConfigured?: boolean };
